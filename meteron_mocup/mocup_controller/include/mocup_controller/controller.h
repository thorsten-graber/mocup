#ifndef MONSTERTRUCK_CONTROLLER_H
#define MONSTERTRUCK_CONTROLLER_H
...
#include <mocup_controller/vehicle_control_interface.h>
#include <mocup_controller/motion_parameters.h>
