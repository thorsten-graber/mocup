#ifndef _ROS_hector_move_base_msgs_MoveBaseGoal_h
#define _ROS_hector_move_base_msgs_MoveBaseGoal_h
...
namespace hector_move_base_msgs
{
  ...
  class MoveBaseGoal : public ros::Msg
  {
    ...
    const char * getType(){ return "hector_move_base_msgs/MoveBaseGoal"; };
    const char * getMD5(){ return "f7d11262450941e69b2cd666bccfd015"; };
