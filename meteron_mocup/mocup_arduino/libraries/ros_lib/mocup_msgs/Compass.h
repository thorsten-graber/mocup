#ifndef _ROS_mocup_msgs_Compass_h
#define _ROS_mocup_msgs_Compass_h
...
namespace mocup_msgs
{
  ...
  class Compass : public ros::Msg
  {
    ...
    const char * getType(){ return "mocup_msgs/Compass"; };
    const char * getMD5(){ return "d008232f5b940b5db5ffc0e8b711366b"; };
