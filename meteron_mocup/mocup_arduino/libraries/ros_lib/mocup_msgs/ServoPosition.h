#ifndef _ROS_mocup_msgs_ServoPosition_h
#define _ROS_mocup_msgs_ServoPosition_h
...
namespace mocup_msgs
{
  ...
  class ServoPosition : public ros::Msg
  {
    ...
    const char * getType(){ return "mocup_msgs/ServoPosition"; };
    const char * getMD5(){ return "34da3b42c9f93d7d1f000179528cfe5e"; };
