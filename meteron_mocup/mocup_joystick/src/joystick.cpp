...
namespace Mocup {
  ...
  mocup_msgs::MotionCommand motionCommand;
...
int main(int argc, char **argv) {
  ...
  motionCommandOutput = n.advertise<mocup_msgs::MotionCommand>("drive", 10, false);
  cameraCommandOutput = n.advertise<geometry_msgs::QuaternionStamped>("camera/command", 10, false);

  ros::param::param("~axis_speed", Mocup::axis_speed, 0);
  ros::param::param("~speed_forward", Mocup::speedForward, 1.0);
  ros::param::param("~speed_backward", Mocup::speedBackward, 1.0);
  ros::param::param("~axis_steer", Mocup::axis_steer, 0);
  ros::param::param("~steer_angle", Mocup::steerAngle, 30.0);
  ros::param::param("~button_brake", Mocup::button_brake, 0);
  ros::param::param("~button_mode", Mocup::button_mode, 0);
  ros::param::param("~button_slow", Mocup::button_slow, 0);
  ros::param::param("~slow_factor", Mocup::slowFactor, 0.5);

  ros::param::param("~axis_camera_pan", Mocup::axis_cameraPan, 0);
  ros::param::param("~axis_camera_tilt", Mocup::axis_cameraTilt, 0);
  ros::param::param("~button_camera_reset", Mocup::button_cameraReset, 0);
  ros::param::param("~camera_mode", Mocup::cameraMode, std::string("base_stabilized"));
  ros::param::param("~camera_speed", Mocup::cameraSpeed, 60.0);
  ros::param::param("~camera_max_pan", Mocup::cameraMaxPan, 120.0);
  ros::param::param("~camera_max_tilt_down", Mocup::cameraMaxTiltDown, 30.0);
  ros::param::param("~camera_max_tilt_up", Mocup::cameraMaxTiltUp, 30.0);
